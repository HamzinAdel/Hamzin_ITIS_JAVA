<html>
	...
	<div class="container">
        <form  action="/behavior" method="get">
		 ...
		 <br><label for="data">Введи свою дату рождения: </label><br>
		  ...
		  <p> <input type="radio" name="help" value="yes"> Да<Br>
		    ...
		    <p>  <input type="radio" name="lie" value="yes"> Да<Br>
			<input type="radio" name="lie" value="no"> Нет<Br>
			...
			<input type="radio" name="school" value="partly"> Не очень<Br></p>
			 ...
			 <p> <br><label for="teacher">Слушаешься ли ты своих учетелей?</label><br></p>
